...
import asw.efood.restaurantservice.client.domain.RestaurantCommandPublisher;
...
public class RestaurantCommandPublisherImpl implements RestaurantCommandPublisher {
    ...
    private Logger logger = Logger.getLogger(RestaurantCommandPublisherImpl.class.toString());
