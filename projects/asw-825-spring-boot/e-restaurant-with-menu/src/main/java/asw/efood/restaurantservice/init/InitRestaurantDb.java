...
//		restaurantService.createRestaurant( "Hostaria dell'Orso", "Roma", "Yogi" );	
//		restaurantService.createRestaurant( "Baffetto", "Roma", "Frank Zappa" );	
//		restaurantService.createRestaurant( "L'Omo", "Roma", "Homo" );	
//		restaurantService.createRestaurant( "Seta", "Milano", "SATA");	
...
//		RestaurantMenu menu; 
		...
		restaurantService.createRestaurantWithMenu( "Hostaria dell'Orso", "Roma", "Yogi", menuItems );	
...
//		restaurantRepository.save(restaurant); 
		...
		restaurantService.createRestaurantWithMenu( "Baffetto", "Roma", "Frank Zappa", menuItems );	
//		menu = new RestaurantMenu(menuItems);
...
//		restaurantRepository.save(restaurant); 
		...
		restaurantService.createRestaurantWithMenu( "L'Omo", "Roma", "Homo", menuItems );	
//		menu = new RestaurantMenu(menuItems);
...
//		restaurantRepository.save(restaurant); 
		...
		restaurantService.createRestaurantWithMenu( "Seta", "Milano", "SATA", menuItems );	
//		menu = new RestaurantMenu(menuItems);
